  ...
  JSON.stringify(
    {
      mcpServers: {
        imprint: {
          command: "npx",
          args: ["tsx", "/path/to/casper-hackathon/imprint-agent/src/mcp/server.ts"],
          env: {
            IMPRINT_MODE: "mock",
            IMPRINT_API_BASE: "http://localhost:4021",
          },
        },
      },
    },
...
const TIERS = [
  {
    ...
    steps: [
      {
        title: "Clone & install",
        code: `git clone https://github.com/YashasviThakur/casper-hackathon.git\ncd casper-hackathon/imprint-agent && npm install\nnpm run http   # starts the paid memory service on :4021`,
      },
      {
        title: "Register with Claude Code",
        code: `claude mcp add imprint --scope user \\\n  -- npx tsx /path/to/casper-hackathon/imprint-agent/src/mcp/server.ts`,
      },
      {
      ...
      },
      {
        ...
        code: `Call search_memories at session start.\nCall save_memory when you learn something.\nEach call signs an x402 payment on Casper.`,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Verify",
        code: `Open a chat in Cursor\nType: "What do you remember?"\nCursor will call search_memories automatically.`,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        title: "Set IMPRINT_MODE",
        code: `Leave IMPRINT_MODE as "mock" to run locally,\nor set the x402 mode to settle each call\non Casper in CSPR.`,
      },
      {
        title: "Run Codex with MCP",
        code: `codex\n# Imprint tools: save_memory, search_memories\n# each write signs an x402 payment on Casper`,
      },
      {
        title: "Verify",
        code: `Ask Codex: "What do you remember?"\nIt will call search_memories and recall context.`,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        title: "Set IMPRINT_MODE",
        code: `Leave IMPRINT_MODE as "mock" to run locally,\nor set the x402 mode to settle each memory\ncall on Casper in CSPR.`,
      },
      {
        title: "Verify",
        code: `Start a new agent session.\nImprint recalls memory and pays per call.`,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        title: "Set IMPRINT_MODE",
        code: `Leave IMPRINT_MODE as "mock" to run locally,\nor switch to the x402 mode to settle each\nmemory call on Casper in CSPR.`,
      },
      {
        title: "Verify",
        code: `Open an agent session in your IDE.\nAsk: "What do you remember?"\nImprint will call search_memories.`,
      },
    ],
  },
];
...
export default function InstallSection() {
  ...
  return (
    <section id="install" className="py-28 md:py-36 px-6 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl text-white tracking-tight"
            ...
            Works with any{" "}
            <em className="italic text-white/40 font-light">agent you run.</em>
          </h2>
          <p style={{ marginTop: 16, fontSize: 14, color: "rgba(255,255,255,0.3)", maxWidth: 480 }}>
            One MCP server. Paid, persistent memory for Claude Code, Cursor, Codex, Antigravity — every call settled on Casper via x402.
          </p>
        </motion.div>
        ...
        >
          <a
            href="https://github.com/YashasviThakur/casper-hackathon/archive/refs/heads/main.zip"
            download
            style={{
